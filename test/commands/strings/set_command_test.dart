...
void main() {
  group('SetCommand', () {
    ...
    test('should build the correct command with strategy', () {
      final command = SetCommand('mykey', 'myvalue', strategyType: SetStrategyTypes.onlyIfNotExists);
    ...
    test('should apply prefix to key', () {
      final command = SetCommand('mykey', 'myvalue', strategyType: SetStrategyTypes.onlyIfExists);
      final prefixedCommand = command.applyPrefix('myprefix:');
      expect(prefixedCommand.commandParts, ['SET', 'myprefix:mykey', 'myvalue', 'XX']);
    });
  });
}
